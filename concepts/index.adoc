...
summary: Aprende conceptos básicos relacionados con el software Element. 
---
= Conceptos
:allow-uri-read: 
:icons: font
...
* link:concept_intro_product_overview.html["Descripción general del producto"]
* xref:concept_solidfire_concepts_solidfire_architecture_overview.adoc[Descripción general de la arquitectura de SolidFire]
* xref:concept_solidfire_concepts_nodes.adoc[Nodos]
* xref:concept_intro_clusters.adoc[Clústeres]
