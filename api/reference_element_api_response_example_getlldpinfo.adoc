...
summary: El método GetLldpInfo devuelve una respuesta similar al siguiente ejemplo. 
---
...
[role="lead"]
El `GetLldpInfo` El método devuelve una respuesta similar al siguiente ejemplo.
