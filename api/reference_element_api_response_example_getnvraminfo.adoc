...
summary: El método GetNvramInfo devuelve una respuesta similar al siguiente ejemplo. 
---
...
[role="lead"]
El `GetNvramInfo` El método devuelve una respuesta similar al siguiente ejemplo.
