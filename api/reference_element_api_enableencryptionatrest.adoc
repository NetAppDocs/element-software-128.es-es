...
NOTE: Este método no permite el cifrado de software en reposo.  Esto solo se puede hacer utilizando ellink:../api/reference_element_api_createcluster.html["método de creación de clúster"^] con `enableSoftwareEncryptionAtRest` empezar a `true` .
