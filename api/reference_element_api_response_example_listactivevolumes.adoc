...
summary: El método ListActiveVolumes devuelve una respuesta similar al siguiente ejemplo. 
---
...
[role="lead"]
El `ListActiveVolumes` El método devuelve una respuesta similar al siguiente ejemplo.
