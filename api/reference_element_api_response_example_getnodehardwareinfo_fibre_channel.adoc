...
summary: El método GetNodeHardwareInfo para nodos Fibre Channel devuelve una respuesta similar al siguiente ejemplo. 
---
...
[role="lead"]
El `GetNodeHardwareInfo` El método para nodos Fibre Channel devuelve una respuesta similar al siguiente ejemplo.
