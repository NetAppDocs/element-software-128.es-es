...
summary: El método GetNetworkConfig devuelve una respuesta similar al siguiente ejemplo. 
---
...
[role="lead"]
El `GetNetworkConfig` El método devuelve una respuesta similar al siguiente ejemplo.
