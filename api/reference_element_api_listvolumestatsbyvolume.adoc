...
summary: Puede utilizar el método ListVolumeStatsByVolume para enumerar las mediciones de actividad de alto nivel para cada volumen, por volumen.  Los valores son acumulativos desde la creación del volumen. 
---
...
[role="lead"]
Puedes usar el `ListVolumeStatsByVolume` método para listar las mediciones de actividad de alto nivel para cada volumen, por volumen.  Los valores son acumulativos desde la creación del volumen.
