...
summary: Puede utilizar el método GetIpmiConfig para recuperar información de sensores de hardware de los sensores que se encuentran en su nodo. 
---
= GetIpmiConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
Puedes usar el `GetIpmiConfig` Método para recuperar información de sensores de hardware de los sensores que se encuentran en su nodo.
...
Tipo de chasis
 a| 
Se utiliza para mostrar información sobre cada tipo de chasis de nodo. Valores posibles:

* all: devuelve información de los sensores para cada tipo de chasis.
* {tipo de chasis}: devuelve información de los sensores para un tipo de chasis especificado.
