...
summary: Puede utilizar el método GetBinAssignmentProperties para recuperar las propiedades de asignación de contenedores en la base de datos. 
---
= ObtenerPropiedadesDeAsignaciónDeContenedor
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes usar el `GetBinAssignmentProperties` Método para recuperar las propiedades de asignación de contenedores en la base de datos.
...
propiedades
 a| 
Detalla las propiedades de todas las asignaciones de contenedores actuales en la base de datos.
 a| 
