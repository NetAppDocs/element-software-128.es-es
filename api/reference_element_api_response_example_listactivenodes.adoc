...
summary: El método ListActiveNodes devuelve una respuesta similar al siguiente ejemplo. 
---
...
[role="lead"]
El `ListActiveNodes` El método devuelve una respuesta similar al siguiente ejemplo.
