...
summary: Puede utilizar el método GetVolumeStats para obtener mediciones de actividad de alto nivel para un solo volumen.  Los valores son acumulativos desde la creación del volumen. 
---
...
[role="lead"]
Puedes usar el `GetVolumeStats` Método para obtener mediciones de actividad de alto nivel para un solo volumen.  Los valores son acumulativos desde la creación del volumen.
...
ID de volumen
 a| 
Especifica el volumen para el cual se recopilan las estadísticas.
 a| 
entero
 a| 
Ninguno
...
estadísticas de volumen
 a| 
Información sobre el volumen de actividad.
 a| 
