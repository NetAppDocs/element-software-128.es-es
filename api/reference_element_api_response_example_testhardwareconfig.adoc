...
summary: El método TestHardwareConfig devuelve una respuesta similar al siguiente ejemplo. 
---
...
[role="lead"]
El `TestHardwareConfig` El método devuelve una respuesta similar al siguiente ejemplo.
