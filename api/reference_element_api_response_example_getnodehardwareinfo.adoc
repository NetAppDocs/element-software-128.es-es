...
summary: El método GetNodeHardwareInfo para iSCSI devuelve una respuesta similar al siguiente ejemplo. 
---
...
[role="lead"]
El `GetNodeHardwareInfo` El método para iSCSI devuelve una respuesta similar al siguiente ejemplo.
