...
summary: 'Puede utilizar el método ListVolumesForAccount para listar los volúmenes activos y los volúmenes \(pendientes\) eliminados de una cuenta.' 
---
...
[role="lead"]
Puedes usar el `ListVolumesForAccount` Método para listar los volúmenes activos y (pendientes de eliminación) de una cuenta.
...
ID de cuenta
 a| 
Se devuelven todos los volúmenes pertenecientes a esta cuenta.
 a| 
entero
 a| 
No
