...
summary: El método GetConfig devuelve una respuesta similar al siguiente ejemplo.  Debido a su longitud, la respuesta contiene información solo para un nodo del clúster. 
---
...
[role="lead"]
El `GetConfig` El método devuelve una respuesta similar al siguiente ejemplo.  Debido a su longitud, la respuesta contiene información solo para un nodo del clúster.
