...
summary: Puede utilizar el método GetNodeSSLCertificate para recuperar el certificado SSL que está actualmente activo en el nodo de administración. 
---
...
[role="lead"]
Puedes usar el `GetNodeSSLCertificate` Método para recuperar el certificado SSL que está actualmente activo en el nodo de administración.
...
certificado
 a| 
El texto completo del certificado codificado en formato PEM.
 a| 
cadena
...
detalles
 a| 
Información decodificada del certificado.
 a| 
Objeto JSON
