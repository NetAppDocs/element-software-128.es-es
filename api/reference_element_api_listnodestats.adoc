...
summary: Puede utilizar el método ListNodeStats para ver las mediciones de actividad de alto nivel de todos los nodos de almacenamiento en un clúster de almacenamiento. 
---
= Estadísticas de nodo de lista
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes usar el `ListNodeStats` Método para visualizar las mediciones de actividad de alto nivel para todos los nodos de almacenamiento en un clúster de almacenamiento.
...
estadísticas del nodo
 a| 
Información de actividad del nodo de almacenamiento.
 a| 
